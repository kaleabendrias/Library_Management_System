...
app_publisher = "Loans in a library"
app_description = "small web application that lets authenticated users manage Books, Members, and"
app_email = "kaleabendrias1212@gmail.com"
app_license = "mit"
